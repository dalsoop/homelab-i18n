    ...
    <section className="panel p-6">
      ...
      <div className="mt-4">
        ...
        <ModuleEditor
          ...
          title="주 모듈(기본 설정)"
          subtitle="별도로 지정되지 않은 모든 작업에는 여기에 제시된 공급자/모델/매개변수가 적용됩니다."
          form={props.llmForm}
          ...
          headerActions={
            <>
              <button
                ...
                type="button"
              >
                {props.mainModelList.loading ? "다운로드 중…" : "모델 목록 가져오기."}
              </button>
              <button
                className="btn btn-secondary"
                  ...
                  <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <button
                        ...
                        type="button"
                      >
                        {task.modelList.loading ? "다운로드 중…" : "모델 목록 가져오기."}
                      </button>
                      <button
                        className="btn btn-secondary btn-sm"
                      ...
                      <>
                        ...
                        <div className="mt-1 flex flex-wrap gap-2">
                          <input
                            ...
                            placeholder={
                              boundProfile
                                ? "이 구성 라이브러리를 사용하는 모듈에 공유할 새 키를 입력하세요. (이 키는 해당 작업에 구성 라이브러리를 연결하는 데 사용됩니다.)"
                                : "주 구성 설정에 대한 새 키를 입력하세요. (이 키는 주 구성 설정으로 되돌리는 작업에 영향을 미칩니다.)"
                            }
                            type="password"
          ...
          {mainAccessState.stage === "ready"
            ...
            : mainAccessState.stage === "missing_key"
              ...
              : mainAccessState.stage === "missing_profile"
                ? "먼저 프로필을 선택하거나 새로 만드신 후, 키를 저장하세요."
                : "현재 모듈의 제공자와 연결된 프로필 설정이 일치하지 않습니다. 먼저 제공자를 통일한 후 저장하거나 테스트를 진행하십시오."}
        </div>
        <div className="mt-2 flex gap-2">
          <input
            className="input flex-1"
            placeholder="새 키를 입력하세요. (이전에 저장된 키는 표시되지 않습니다.)"
            name="api_key"
            type="password"
            value={props.apiKey}
